...
const ca = {
  ...
  hero: {
    ...
    rating: {
      score: '4,9',
      reviews: '57 ressenyes a Google',
      aria: 'Valoració de 4,9 sobre 5 estrelles a Google · 57 ressenyes. Obrir a Google Maps',
    },
  },
  menu: {
    ...
    items: {
      ...
      otros: [
        { name: 'Cafè Latte', price: '3,00 €', desc: "Cafè espresso d'alta qualitat, combinat amb llet cremosa, perfecte per a qui busca un sabor equilibrat i clàssic." },
        { name: 'Cafè Oreo', price: '3,50 €', desc: "El nostre Latte clàssic amb sabor a galeta Oreo, dolç, divertit i amb un toc irresistible." },
        { name: 'Matcha Latte', price: '3,80 €', desc: "Beguda a base de te matcha i llet, amb un sabor verd característic, suau i diferent." },
        { name: 'Cafè French Vainilla', price: '3,20 €', desc: "El nostre Latte clàssic amb aroma de vainilla francesa, dolç subtil, elegant i cremós." },
        { name: 'Cafè Lotus', price: '3,50 €', desc: "El nostre Latte clàssic amb sabor a galeta Lotus, sabor caramel·litzat, especiat i cremós." },
        { name: 'Cafè Mocha', price: '3,50 €', desc: "El nostre Latte clàssic amb sirope de xocolata i un toc cremós, ideal per a qui prefereix sabors dolços i intensos." },
        { name: 'Cafè Mocha White', price: '3,50 €', desc: "El nostre Latte clàssic amb sirope de xocolata blanca i un toc cremós, ideal per a qui prefereix sabors dolços i suaus." },
        { name: 'Chai Latte', price: '3,80 €', desc: "Mescla aromàtica de te negre, espècies i llet cremosa, amb notes especials de canyella, gingebre i cardamom, entre d'altres. Tota una experiència." },
      ],
    },
  },
  claim: {
  ...
  nosotros: {
    ...
    foundersAlt: "Juan i Anna, fundadors de Beikit Bakery, davant del seu local a Granollers",
    foundersRole: 'Fundadors, Beikit Bakery',
  },
  ...
  meta: {
    homeTitle: 'Beikit Bakery | American Bakery a Granollers',
    homeDesc: "Galetes, cheesecakes i milkshakes artesanals. American Bakery a Granollers. Comandes a domicili per Uber Eats.",
    homeOgDesc: 'Galetes, cheesecakes i milkshakes artesanals. Heartmade Everyday.',
  },
  legal: {
