const es = {
  ...
  hero: {
    ...
    rating: {
      ...
      aria: 'sobre 5 estrellas. Abrir en Google Maps',
    },
  },
  menu: {
    ...
    items: {
      ...
      otros: [
        { name: 'Café Latte', price: '3,00 €', desc: 'Café espresso de alta calidad, combinado con leche cremosa, perfecto para quienes buscan un sabor equilibrado y clásico.' },
        { name: 'Café Oreo', price: '3,50 €', desc: 'Nuestro Latte clásico con sabor a galleta Oreo, dulce, divertido y con un toque irresistible.' },
        { name: 'Matcha Latte', price: '3,80 €', desc: 'Bebida a base de té matcha y leche, con un sabor verde característico, suave y diferente.' },
        { name: 'Café French Vainilla', price: '3,20 €', desc: 'Nuestro Latte clásico con aroma de vainilla francesa, dulce sutil, elegante y cremoso.' },
        { name: 'Café Lotus', price: '3,50 €', desc: 'Nuestro Latte clásico con sabor a galleta Lotus, sabor caramelizado, especiado y cremoso.' },
        { name: 'Café Mocha', price: '3,50 €', desc: 'Nuestro Latte clásico con sirope de chocolate y un toque cremoso, ideal para quienes prefieren sabores dulces e intensos.' },
        { name: 'Café Mocha White', price: '3,50 €', desc: 'Nuestro Latte clásico con sirope de chocolate blanco y un toque cremoso, ideal para quienes prefieren sabores dulces y suaves.' },
        { name: 'Chai Latte', price: '3,80 €', desc: 'Mezcla aromática de té negro, especias y leche cremosa, con notas especiales de canela, jengibre y cardamomo, entre otras. Toda una experiencia.' },
      ],
    },
  },
  claim: {
